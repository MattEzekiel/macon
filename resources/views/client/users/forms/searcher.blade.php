...
@if(count($users_filters) > 0)
    <search>
        ...
        <div class="lg:hidden mb-4">
            <div class="collapse bg-base-200">
                ...
                <div class="collapse-content">
                    <form action="{{ route('client.users') }}" method="get" class="flex flex-col gap-2.5 mt-1.5">
                        ...
                        <div class="flex gap-2.5">
                            ...
                            <a class="btn btn-error btn-outline" href="{{ route('client.users') }}">
                                {{ __('general.reset') }}
                            </a>
                        </div>
                    </form>
        ...
        <!-- Filtros para pc -->
        <form action="{{ route('client.users') }}" method="get" class="hidden lg:flex flex-wrap gap-2.5 items-center mt-1.5">
            @foreach($users_filters as $key => $value)
                @if($key !== 'client')
